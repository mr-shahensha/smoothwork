...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
            ...
            <?php
            $fld1['eid'] = $Members->User_Details->username;
            $op1['eid'] = "=,";
                ...
                <div class="box box-success">
                    <table border="0" width="80%" class="table table-hover table-striped table-bordered">
                        <tbody>
                            <tr>
                                <th>
                                    <font color="#000000">Employee ID</font>
                                </th>
                                <td>
                                    <font color="#000000"><?php echo $eid; ?></font>
                                </td>
                            </tr>
                            <tr>
                                <th>Name</th>
                            ...
                            <tr>
                                <th>Mobile No.</th>
                                <td>
                                    <font color="#000000"><?php echo $mob; ?></font>
                                </td>
                            </tr>
                            <tr>
                                <th>Aadhar Number</th>
                                <td>
                                    <font color="#000000"><?php echo $ptp['eadnum']; ?></font>
                                </td>
                            </tr>
                            <tr>
                                <th>Joining Date</th>
                                <td>
                                    <font color="#000000"><?php echo $ptp['jdt']; ?></font>
                                </td>
                            </tr>
                            <tr>
                                <th>Adress</th>
                                <td>
                                    <font color="#000000"><?php echo $ptp['eadrs']; ?></font>
                                </td>
                            </tr>
                            <tr>
                                <th>Password</th>
                                <td><a onclick="chPass()" style="cursor:pointer;">Change Password</a></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
