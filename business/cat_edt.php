...
$adtl  = new Init_Table();
$adtl->set_table("main_service_category","sl");
$row=$adtl->all();
...
<label>
<b><font color="#ed2618"></font>Category : </b>
</label>
<input type="text" id="cat_nm" name="cat_nm" class="form-control" value="<?php echo $row2[0]['cat_nm'];?>" style="width:100%" placeholder="Enter Category" required>
</div>
...
<input type="hidden" name="table_name" value="main_service_category">   
<input type="hidden" name="page_name" value="category.php">  
