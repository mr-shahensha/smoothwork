...
$adtl = new Init_Table();
$adtl->set_table("main_test_photo", "sl");
$row = $adtl->all();
        ...
        <div class="box box-primary">
          ...
          <div class="box-body">
            <form name="form" id="form" method="post" action="test_photos.php" enctype="multipart/form-data">
              <input type="hidden" name="sl" id="sl" value="<?php echo $row2[0]['sl']; ?>">
              <div class="card-body">
                <div class="row">

                  <div class="col-md-12">
                    <div class="form-group">
                      <label for="Name">Title<b style="color:Tomato;">*</b></label>
                      <input type="text" class="form-control" id="ttl" name="ttl" value="<?php echo $row2[0]['ttl']; ?>"
                    ...
                    <div class="form-group text-center">
                      ...
                      <label>
                        <label for="fileToUpload" title="Click To Chose Picture">
                          <img id="blah" src="<?php echo $path;?>" alt="Upload Image"
                           style="width:670px; height:170px; cursor:pointer;" />
                        </label>
