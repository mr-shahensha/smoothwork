            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><?php echo "Pending request for joining Smoothwork's business end"; ?></h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
...
<script>
    function show() {
        $('#show').load("joinreq_list.php").fadeIn('fast');
    }
    ...
    function acrj(val, id) {
        ...
        if (confirm(text) == true) {
            $('#show2' + id).load("joinreq_acrj.php?val=" + val + "&sl=" + id+"&pg=").fadeIn('fast');
        }
    }
</script>
</body>
