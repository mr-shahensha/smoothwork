...
<input type="text" id="cat_nm" name="cat_nm" class="form-control" value="" style="width:100%" placeholder="Enter Test Type" required>
</div>
...
<input type="hidden" name="table_name" value="main_category">	 
...
function show()
{
	$('#show').load("cat_list.php").fadeIn('fast');
}
