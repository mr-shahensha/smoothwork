...
<body>
  ...
  <section class="wrapper">
    <div class="container">
      ...
      <b><a href="#" class="link-underline-info" style="margin-left:500px;">Login to explore more &rarr;</a></b>
    ...
    <section id="service" class="services pt-0">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row gy-4">
          ...
          $row2 = $list2->search_custom($fld2, $op2, 'limit 3', array('sl' => 'ASC'));
          $pdo2 = new MainPDO();
          ...
          ?>
            ...
            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
              <div class="card">
                ...
                <h3><a href="service-details.html" class="stretched-link"><?php echo $value2['snm']; ?></a></h3>
      ...
      <b><a href="login.php" class="link-underline-info" style="margin-left:500px;">Login to explore more &rarr;</a></b>
